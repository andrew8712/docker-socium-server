...
console.log("productionPfx: ", productionPfx);
...
var devPushConfig;
console.log("devBundleId: ", devBundleId);
console.log("devPfx: ", devPfx);
...
console.log("iosPushConfigs: ", iosPushConfigs);
...
console.log("verifyUserEmails: ", verifyUserEmails);
...
// public directory contains Terms of Service and Privacy Policy files.
...
if (liveQuery) {
  ...
  app.listen(port, function() {
    console.log("Socium server running on " + serverURL + " (:" + port + mountPath + ")");
  });
}
